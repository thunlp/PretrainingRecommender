...
parser.add_argument('--dataset_split_seed', type=int, default=87654)#98765
...
parser.add_argument('--dataloader_random_seed', type=float, default=0.7)#0.0
parser.add_argument('--train_batch_size', type=int, default=64)
parser.add_argument('--val_batch_size', type=int, default=64)
parser.add_argument('--test_batch_size', type=int, default=64)
parser.add_argument('--umap', type=str, default='Data/ml-1m/umap.pkl')
parser.add_argument('--smap', type=str, default='Data/ml-1m/smap.pkl')
parser.add_argument('--meta', type=str, default='Data/ml-1m/seq_meta.pkl')
parser.add_argument('--tmap', type=str, default='Data/ml-1m/rev.pkl')#stmap
parser.add_argument('--dire_size', type=int, default=1186)
parser.add_argument('--acto_size', type=int, default=4170)
...
parser.add_argument('--test_negative_sampling_seed', type=int, default=87654)
...
parser.add_argument('--model_init_seed', type=int, default=34125)#None
# BERT #
