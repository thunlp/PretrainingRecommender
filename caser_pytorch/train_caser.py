...
if __name__ == '__main__':
    ...
    parser.add_argument('--eval_root', type=str, default='datasets/newdat/b_eval.txt')
    parser.add_argument('--test_root', type=str, default='datasets/newdat/b_test.txt')
    parser.add_argument('--nega_eval', type=str, default='datasets/newdat/nega_sample_b_eval.pkl')
    parser.add_argument('--nega_test', type=str, default='datasets/newdat/nega_sample_b_test.pkl')
